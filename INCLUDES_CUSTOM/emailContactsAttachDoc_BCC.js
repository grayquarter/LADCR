...
emailContacts_BCC
  ...
  Optional Params: (use blank string, not null, if missing!)
     ...
     attachDocs = Will set up envrionment variable to attach generated report documents to emails
 ...
 */
    function emailContactsAttachDoc_BCC(sendEmailToContactTypes, emailTemplate, vEParams, reportTemplate, vRParams) {
